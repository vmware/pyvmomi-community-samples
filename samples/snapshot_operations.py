...
parser.add_argument("server", help="Type the vCenter server FQDN. Ex lab.vcenter.local")
parser.add_argument("vm", help="Type the virtual machine name. Ex. host.vcenter.local")
