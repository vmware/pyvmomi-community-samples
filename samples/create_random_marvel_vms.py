...
def main():
    ...
    if marvel_public_key == '' or marvel_private_key == '':
        print("\nPlease configure your Marvel Public/Private API Key by "
              "setting marvel_public_key and marvel_private_key variable\n")
        return -1
    ...
    try:
        ...
        print("Connecting to Marvel API and retrieving " + args.count +
              " random character(s) ...")
