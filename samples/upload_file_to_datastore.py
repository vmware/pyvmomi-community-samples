...
def main():
    ...
    try:
        ...
        # Break apart the cookie into it's component parts - This is more than is needed, but
        # a good example of how to break apart the cookie anyways. The verbosity makes it clear
        # what is happening.
